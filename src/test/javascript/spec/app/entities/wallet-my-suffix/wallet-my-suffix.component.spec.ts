...
import { WalletMySuffixComponent } from 'app/entities/wallet-my-suffix/wallet-my-suffix.component';
...
describe('Component Tests', () => {
  describe('WalletMySuffix Management Component', () => {
    let comp: WalletMySuffixComponent;
    let fixture: ComponentFixture<WalletMySuffixComponent>;
    let service: WalletMySuffixService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [WallethistoryTestModule],
        declarations: [WalletMySuffixComponent],
        providers: [
          {
        ...
        .overrideTemplate(WalletMySuffixComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(WalletMySuffixComponent);
